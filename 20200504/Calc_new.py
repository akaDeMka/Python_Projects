...
user_list = [                                               #Структура пользовательских данных
    {                                               
        'ФИО': '',
        'Пол': '',
        'Возраст':'',
...
while key!='q' and key!='й':                                #тело программы в цикле
    ...
    if key=="1":                                             #1. Ввести нового пользователя
        ...
        user_list[users]['Пол']=input('Введите Пол: ')
        user_list[users]['Возраст']=input('Введите Возраст: ')
        user_list[users]['Вес']=input('Введите Вес: ')
        user_list[users]['Рост']=input('Введите Рост: ')
    ...
    elif key=='4'and users:                                 #4. Вывести список пользователей - можно сделать более красивый вывод
