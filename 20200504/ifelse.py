...
while key_cup!='n' and key_cup!='т':
    ...
    try:
        ...
        if (a != 0) and (b != 0) and (c != 0):                          #Если нет ни одного нуля - вывести: "Нет нулевых значений!!!"
            print("Нет нулевых значений!!!")

        print(a*b*c and "Нет нулевых значений!!!" or "Есть нули!!!")     #без if Если нет ни одного нуля

        if a!=0:                                                        #Вывести первое ненулевое значение. Если введены все нули - вывести "Введены все нули!" (цикл не использовать)
            print("Первое ненулевое значение - а = ",a)
        elif b!=0:
            print("Первое ненулевое значение - b = ",b)
        elif c!=0:
            print("Первое ненулевое значение - c = ",c)
        else: 
            print("Введены все нули!")
                        
        print('Первое ненулевое значение -',a or b or c or 'Введены все нули')  # без if Вывести первое ненулевое значение. Если введены все нули - вывести "Введены все нули!
